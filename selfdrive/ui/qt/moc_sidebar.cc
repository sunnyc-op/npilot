...
QT_MOC_LITERAL(7, 57, 14), // "batteryPercent"
QT_MOC_LITERAL(8, 72, 10), // "ItemStatus"
QT_MOC_LITERAL(9, 83, 11), // "pandaStatus"
QT_MOC_LITERAL(10, 95, 10), // "tempStatus"
QT_MOC_LITERAL(11, 106, 7), // "netType"
QT_MOC_LITERAL(12, 114, 11), // "netStrength"
QT_MOC_LITERAL(13, 126, 8) // "wifiAddr"

    },
    "Sidebar\0openSettings\0\0valueChanged\0"
    "updateState\0UIState\0s\0batteryPercent\0"
...
void Sidebar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< ItemStatus*>(_v) = _t->battery_percent; break;
        ...
        switch (_id) {
        case 0:
            if (_t->battery_percent != *reinterpret_cast< ItemStatus*>(_v)) {
                _t->battery_percent = *reinterpret_cast< ItemStatus*>(_v);
